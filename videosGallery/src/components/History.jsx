...
import shorts1 from './videos/shorts-1.mp4'

import shorts3 from './videos/shorts-3.mp4'
import shorts4 from './videos/shorts-4.mp4'
import shorts5 from './videos/shorts-5.mp4'
import shorts6 from './videos/shorts-6.mp4'
import shorts7 from './videos/shorts-7.mp4'
                ...
                <div className="col-md-11 " style={{ marginLeft: "110px", marginTop: "50px" }}>
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            ...
                            <h4 className="fw-bold ms-3 mt-3">Today</h4>
                            <h6 className=" fw-bold ms-3 mt-4">Shorts</h6>
                            ...
                            <Swiper
                                ...
                                className="mySwiper "
                            >
                                <SwiperSlide><video src={shorts1} className='w-100 ' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts7} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts3} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts4} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts5} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts6} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts1} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts7} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts3} className='w-100' controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts4} className='w-100' controls></video></SwiperSlide>
                            ...
                            <h6 className=" fw-bold ms-3 mt-4">Videos</h6>

                            <div className="row">
                                <div className="col-md-6">
                                    <Link to="/Rabbit"><video className='ms-3 mt-3 ' src={video} style={{ width: "350px", height: "200px" }}></video>
                                    </Link> </div>

                                <div className="col-md-6">
                                    <h4 className="mt-5 fs-3"> Rabbit</h4>

                                    <p className="text-muted mb-1 ">Animals Gallery</p>
                                    <small className=''>9.5M views . 1 year ago</small></div>

                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <Link to="/Lion"><video className='ms-3 mt-3 ' src={video4} style={{ width: "350px", height: "200px" }}></video>
                                    </Link> </div>

                                <div className="col-md-6">
                                    <h4 className="mt-5 fs-3"> Lion</h4>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <Link to="/Swan"><video className='ms-3 mt-3 ' src={video2} style={{ width: "350px", height: "200px" }}></video>
                                    </Link> </div>

                                <div className="col-md-6">
                                    <h4 className="mt-5 fs-3"> Swan</h4>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <Link to="/Deers"><video className='ms-3 mt-3 ' src={video11} style={{ width: "350px", height: "200px" }}></video>
                                    </Link> </div>

                                <div className="col-md-6">
                                    <h4 className="mt-5 fs-3"> Deers</h4>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <Link to="/Fox"><video className='ms-3 mt-3 ' src={video14} style={{ width: "350px", height: "200px" }}></video>
                                    </Link> </div>

                                <div className="col-md-6">
                                    <h4 className="mt-5 fs-3"> Fox</h4>

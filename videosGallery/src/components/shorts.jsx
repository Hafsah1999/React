...
import shorts2 from './videos/shorts-2.mp4'
                    ...
                    <div className="col-md-11 " style={{ marginLeft: "110px" }}>
                        <div className="row">
                            ...
                            <Swiper
                                ...
                                className="mySwiper"
                            >
                                <SwiperSlide><video src={shorts1} autoPlay controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts2} autoPlay controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts3} autoPlay controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts4} autoPlay controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts5} autoPlay controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts6} autoPlay controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts7} autoPlay controls></video></SwiperSlide>
                                <SwiperSlide><video src={shorts1} autoPlay controls></video></SwiperSlide>
                            </Swiper>
